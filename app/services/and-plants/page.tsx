...
const faqItems = [
  {
    q: "AND PLANTS（アンドプランツ）の口コミ・評判は？",
    a: "公開口コミの傾向としては、「梱包が丁寧で美しい」「植物の品質・鉢のインテリア性が高い」「植え替え済み・ケアカード付きで初心者に優しい」といった好意的な声が多い一方、「価格が高い」という声が最も多く、「樹形を指定できず思っていた形と違う」「稀に配送トラブル」といった気になる声もあります（App Storeの花単発アプリ4.4★/23件ほか・2026年7月時点。定期便総合の平均★は未掲載）。回数縛りはなくいつでも解約できるため、まず1回試して相性を見るのがおすすめです。",
  },
  {
